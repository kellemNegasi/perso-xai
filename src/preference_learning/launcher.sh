...
AUTOXAI_3METRICS_DIR=${AUTOXAI_3METRICS_DIR:-$RESULTS_ROOT/preference_learning_simulation_aligned_tie_breaking/aut_xai_comp_3-metrics}
AUTOXAI_ALLMETRICS_DIR=${AUTOXAI_ALLMETRICS_DIR:-$RESULTS_ROOT/preference_learning_simulation_aligned_tie_breaking/aut_xai_comp_all-metrics}
PREFERENCE_ONLY_DIR=${PREFERENCE_ONLY_DIR:-$RESULTS_ROOT/preference_learning_simulation_aligned_tie_breaking/preference_only_all_personas}
